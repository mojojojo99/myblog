...
The fact that multiple parents can be waiting on multiple children in a multi-threaded environment suggests that some concurrency structures must be in place to prevent race conditons. 
